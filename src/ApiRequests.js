const requests = {
  ...
  topRatedMovie: `/movie/top_rated?api_key=${process.env.REACT_APP_API_KEY}&include_video=false&page=9&language=en-US`,
  actionMovies: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&include_video=false&page=5&with_genre=28&language=en-US`,
  comedyMovies: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genre=35&page=2&language=en-US`,
  ...
  animationMovies: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genre=12&language=en-US`,
  ...
  topRatedTv: `/tv/top_rated?api_key=${process.env.REACT_APP_API_KEY}&page=2&language=en-US`,
  ...
  comedyTv: `/discover/tv?api_key=${process.env.REACT_APP_API_KEY}&include_video=false&page=3&with_genre=35&language=en-US`,
  crimeTv: `/discover/tv?api_key=${process.env.REACT_APP_API_KEY}&with_genre=80&language=en-US`,
  documentaryTv: `/discover/tv?api_key=${process.env.REACT_APP_API_KEY}&include_video=false&page=1&with_genre=99&language=en-US`,
  ...
  onAir: `/tv/on_the_air?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=1`,
};
